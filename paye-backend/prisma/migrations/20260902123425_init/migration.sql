...
CREATE TABLE `User` (
    ...
    `interestedIn` ENUM('MEN', 'WOMEN', 'EVERYONE') NOT NULL DEFAULT 'EVERYONE',
    `preferredSports` VARCHAR(191) NULL,
    `preferredSessionTypes` VARCHAR(191) NULL,
...
-- AddForeignKey
ALTER TABLE `Request` ADD CONSTRAINT `Request_profileId_fkey` FOREIGN KEY (`profileId`) REFERENCES `Profile`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
